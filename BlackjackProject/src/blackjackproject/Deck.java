...
public class Deck {
   ...
   public void createTestingDeck(){     // tämä deckki on VAIN TESTAUSTA VARTEN
       ...
       Card three= new Card(hearts, Value.NINE  );     // 1st dealercard = revealed dealercard
       Card four= new Card(hearts, Value.ACE);      // 2nd dealercard = UNKNOWN card
       Card five= new Card(hearts, Value.ACE);      // fifth card = splitgame card taken from the testing deck to the sidehand

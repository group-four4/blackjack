...
*/
    ...
    //    int boundaryValueForShuffle= (int)( (numberOfDecksUsed*52)/4 );                  // boundaryValue is the variable against which the remainingCArds variable is checked
        ...
        while(weArePlaying){
            ...
            /////HUOM TÄRKEÄÄ!!! controller.playerBettinSideBet 
//            if (splitWasMade) {
//                playerIsBankrupt = controller.playerBettingSideBet(sideBet);
//                if (playerIsBankrupt) {
//                    break;
//                }
//                else{
//                    Bankaccount sidePot= new Bankaccount(sideBet);   //luodaan samalla uuden olion nimeltä sidePot ==> sinne  tallennetaan pottiin sideBetin arvo, 
//                }
//                
//            }
            ...
            if (splitWasMade && naturalBlackJackresult==0){            // mennään sisään split haaraan ohjelmassa
                ...
                Hand sidehand = new Hand(testdeck);      // HUOM TÄRKEÄ!!! TESTDECKiin viittaus constructorissa ONLY TESTING PURPOSES!!! luodaan sidehand olio
                ...
                view.printRevealedDealerCardAndPlayerCards(dealerhand, sidehand);
                     // tämä variable myöhemmin tallentaa sidegamen lopputuloksen, en ole varma onko juurikaan tarpeellinen mutta onpahan tehty /// näitä gameResult variableja voi käyttää bettien voittamisen laskemiseen.
